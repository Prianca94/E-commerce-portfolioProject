...
import { serviceSetting } from "../Data/data";
...
const Home = () => {
  return (
    <>
      ...
      <Container class1="home-wrapper-2 py-4 px-3">
        <div className="row">
          <div className="col-12">
            <div className="services d-flex align-items-center justify-content-between">
              {serviceSetting?.map((item) => (
                <>
                  <div className="d-flex align-items-center gap-10" key={item.title}>
      ...
      <Container class1="featured-wrapper blog-wrapper home-wrapper-2 py-2">
        <div className="row">
          <div className="col-12">
      ...
      <Container class1="special-product-wrapper home-wrapper-2 py-2">
        <div className="row">
          <div className="col-12">
...
<Container class1="popular-products-wrapper blog-wrapper home-wrapper-2 py-2">
<div className="row">
            <div className="col-12">
