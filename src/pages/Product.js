...
const Product = () => {
  ...
  return (
    <>
          ...
          <div className="col-6">
            <div className="main-product-details">
              <div className="details-border d-flex align-items-center justify-content-between">
                <h3 className="title mt-2">Camera for professional adults high dimension 5.0</h3>
                  ...
                  <div className="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div className="accordion-item">
                      ...
                      <div id="flush-collapseTwo" className="accbody accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                        <div className="accordion-body">
                          <p>High resolution (2,360K dot) OLED Live View Finder and rear touch enabled 3 inch tilt/swivel LCD display (1,040 dot) are clear even in bright sunlight, Image sensor size 17.3 x 13.0 mm (in 4:3 aspect ratio)</p>{" "}
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      ...
                      <div id="flush-collapseThree" className="accbody accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                        <div className="accordion-body">
                          <p>16 megapixel Micro Four Thirds sensor with no low pass filter to confidently capture sharp images with a high dynamic range and artifact free performance; WiFi enabled</p>{" "}
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <Container class1="popular-products-wrapper blog-wrapper home-wrapper-2 py-2 p-2">
        <div className="row">
          <div className="col-12">
